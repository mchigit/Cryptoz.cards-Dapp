      ...
      <div class="row">
        <div id="button-container">
          <div class="primary-actions">
            <SortDropdown :disabled="!ownsCards" @sort-by-attr="sortByAttr"></SortDropdown>
            <b-button
          ...
          <div class="crypt-actions">
            ...
            <b-input-group class="crypt-search-input-group">
              ...
              ></b-form-input>
              <input ref="myCrypt" id="my-crypt-link" hidden :value="getMyCryptLink" />
              <b-input-group-append>
                <b-button
                  @click="() => goToCrypt()"
                  :disabled="disableSearch"
                  variant="success"
                  >See Another Crypt</b-button
                >
              </b-input-group-append>
            </b-input-group>
          </div>
            ...
            window.Cryptoz.deployed()
              ...
              .then(function(res) {
                ...
                if (res.attributes.edition_total == 0) {
                  //unlimited
                  res.attributes.edition_label =
                    "#" + res.attributes.edition_current;
                } else {
                  res.attributes.edition_label =
                    "#" +
                    res.attributes.edition_current +
                    " of " +
                    res.attributes.edition_total;
                }
